...
%% This configuration is passed to Cowboy
%% when starting listeners using cowboy:start_http/4 or cowboy:start_https/4 functions.
%% It can be updated without restarting listeners using the Ranch
%% functions ranch:get_protocol_options/1 and ranch:set_protocol_options/2.
%% http://ninenines.eu/docs/en/cowboy/HEAD/manual/cowboy_protocol/
